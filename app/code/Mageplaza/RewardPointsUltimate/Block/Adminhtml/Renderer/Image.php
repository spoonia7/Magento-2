...
namespace Mageplaza\RewardPointsUltimate\Block\Adminhtml\Renderer;

/**
 * Class Image
 * @package Mageplaza\RewardPointsUltimate\Block\Adminhtml\Renderer
 */
class Image extends \Mageplaza\Core\Block\Adminhtml\Renderer\Image
{
    ...
    protected function _getDeleteCheckbox()
    {
        ...
        $html .= '<style>#tier_image_image{ position: relative;top: 6px }</style>';
