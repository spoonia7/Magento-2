 ...
 * Class MassDisable
 */
class MassDisable extends \Webkul\MobikulCore\Controller\Adminhtml\Bannerimage
{
    /**
    ...
    public function execute()
    {
        ...
        $collection->setBannerimageData($coditionData, ["status" => 0]);
        if ($bannersUpdated) {
            $this->messageManager->addSuccess(__("A total of %1 record(s) were disabled.", $bannersUpdated));
        }
