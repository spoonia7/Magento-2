 ...
 * Class Thumbnail
 */
class SellerThumbnail extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
     * Function render
     *
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        if ($row->getLogoPic()) {
            $imageUrl = $target.'avatar/'.$row->getLogoPic();
        } else {
            $imageUrl = $target.'avatar/noimage.png';
        }
