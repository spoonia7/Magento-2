 ...
 * Webkul Software.
 */
class UploadBannerPic extends \Webkul\MobikulApi\Controller\ApiController
{
    /**
     *
    ...
    /**
     * Construct Function for Class UploadBannerPic
     *
    ...
    /**
     * Function Execute for UploadBannerPic Class
     *
    ...
    public function execute()
    {
        ...
        if (isset($this->files)) {
            ...
            try {
                $this->uploadHelper->uploadPicture($this->files, $this->customerId, $this->customerId."-banner", "banner");
                $this->returnArray = $this->uploadHelper->resizeAndCache($this->width, $this->customerId, $this->mFactor, "banner");
            } catch (\Exception $e) {
