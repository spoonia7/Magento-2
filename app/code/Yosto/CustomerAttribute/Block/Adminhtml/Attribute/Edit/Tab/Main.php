...
class Main extends AbstractMain
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->_eventManager->dispatch('customer_attribute_form_build_main_tab', ['form' => $form]);
    ...
    {
        return ['apply' => \Yosto\CustomerAttribute\Block\Adminhtml\Attribute\Helper\Form\Apply::class];
    }
