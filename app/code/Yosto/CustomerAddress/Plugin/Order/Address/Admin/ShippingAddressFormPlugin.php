...
/**
 * Add custom attributes data to shipping form at sales_order_create_index in admin
 *
 * Class ShippingAddressFormPlugin
...
class ShippingAddressFormPlugin
{
    ...
    public function afterGetFormValues(\Magento\Sales\Block\Adminhtml\Order\Create\Shipping\Address $subject, $result) {
        ...
        if($address->getCustomerAddressId() != null) {
            try {
                ...
                $this->_logger->error('Shipping form - when create order in admin: ' . $e->getTraceAsString());
            }
        }
